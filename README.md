...
Creating a dynamic data pipeline in ADF to run a for each loop to fetch files (total 10 files) from github (HTTP source) to Azure Data lake inside bronze container.
...
Databricks cluster was created and connected to azure storage to access the bronze layer data. 
This data can now be cleaned, transformed and saved as parquet file in Azure data lake in silver container. 

<img width="1914" height="914" alt="image" src="https://github.com/user-attachments/assets/d39816dd-ba6a-4efd-9ab2-2ad882074b3a" />

### Gold Layer 

Created a schema and database to organize the data. 

<img width="1917" height="391" alt="image" src="https://github.com/user-attachments/assets/ca9d40db-db1a-4b61-b6c1-98c1aac598d5" />

Created external table and views which will serve as the gold layer and can be accessed inside PowerBI using Synapse analytics sql connection. 
